  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 pb-24 pt-6 sm:px-5">
      ...
      <section className="mb-5 rounded-[1.5rem] border border-[var(--q-line)] bg-white px-4 py-8 sm:px-8">
        ...
        {/*
          ⚠️ يُقال إن الآيات تُلمس — وإلا بقيت الميزة سرًّا بين من
          كتبها ومن يقرأ الكود.

          ⚠️ ويُوصف العملُ خطوتين لا خطوة: كُتب أوّلًا «اضغط على أي آية
          لتسمعها»، فجرّبته صاحبة المنصة وقالت إن الضغطة لا تُسمع —
          وهي محقّة، فاللمسةُ تفتح الخيارات واللمسةُ الثانية تختار.
          ووعدٌ بخطوةٍ واحدة يُنجَز في خطوتين وعدٌ ناقص.

          ⚠️ ولم نكتب «ضغطتين» لأنها تُقرأ نقرًا مزدوجًا سريعًا، وليس
          ذاك ما يقع: لمستان منفصلتان بينهما اختيار.
        */}
        <p className="mt-5 text-center text-[0.78rem] leading-relaxed text-[var(--q-mute)]">
          اضغط على أي آية، ثم اختر: 🔊 استماع · ✅ انتهيت
        </p>
      </section>
