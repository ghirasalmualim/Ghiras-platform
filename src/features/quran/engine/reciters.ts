...
export const RECITERS: Reciter[] = [
  ...
  },
  {
    ...
    style: 'مرتّل',
    base_url: 'https://cdn.islamic.network/quran/audio/128/ar.mahermuaiqly',
    licence:
      'يجيز المصدر تضمين التلاوات في منتج تجاري، وتبقى حقوق التلاوة للقارئ',
    source_note: [
      'المصدر: AlQuran Cloud / Islamic Network CDN — نفس شروط بقية القرّاء،',
      'وهي شروط عامة للخدمة كلها لا بيان خاص بكل قارئ.',
      '',
      'تُحقِّق منه بـ`npm run quran:reciter ar.mahermuaiqly` في ٢٠٢٦-٠٨-١٩:',
      '  • النوع versebyverse، والتلاوة كاملة بنفس الترقيم.',
      '  • عيّنة ثلاثين آية موزّعة على المصحف كلها تعمل.',
      '  • ارتباط المدة بعدد كلمات الآية = ٠٫٩٦٩، والترقيم مزاحًا = ٠٫٥٢١.',
      '',
      '⚠️ الشيخ ماهر المعيقلي حيّ، فينطبق عليه ما ينطبق على العفاسي',
      'والحذيفي: وجود التلاوة على المصدر ليس ضمانًا دائمًا.',
    ].join('\n'),
    is_active: true,
  },
];
