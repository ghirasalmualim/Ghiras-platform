...
/**
 * صفحة «الأداة للمشتركات» — تظهر عند محاولة فتح سجل الدرجات بحساب غير مشترِك،
 * بدل التوجيه الصامت للصفحة الرئيسية.
 */
export const dynamic = 'force-dynamic';

export default function GradebookLockedPage() {
  return (
