...
const GAMES = [
  ...
  {
    href: '/clock',
    tag: 'كورس مستقل · بسعره الخاص',
    emoji: '🕐',
    title: 'الساعة التفاعلية',
    desc: 'كورس كامل لتعلّم قراءة الساعة: اسحب العقارب بإصبعك، نطق الوقت بالعربية، «كم الساعة؟» و«اضبط الوقت» وسباق — بخمسة مستويات وأوسمة. منتج مستقل بسعره الخاص.',
  },
  {
    href: '/balloons',
    tag: 'مسابقات',
