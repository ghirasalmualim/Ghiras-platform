...
/**
 * صفحة «إدارة المدرسة — للمشتركات» — تظهر عند محاولة فتح إدارة المدرسة بحساب
 * لا يملك اشتراك school_until ولا عضوية في أي مدرسة.
 */
  ...
  return (
    <main className="min-h-dvh flex flex-col items-center justify-center px-5 py-10 text-center">
      ...
      <div className="card-3d w-full max-w-md p-10 mt-6 animate-float-in" style={{ animationDelay: '0.1s' }}>
        ...
        <h1 className="mt-4 text-xl font-extrabold text-ink">إدارة المدرسة — خاصة بالمشتركين</h1>
